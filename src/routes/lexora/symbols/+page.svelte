<script lang="ts">
    ...
    let searchResults: Symbol[] = $state([]);
    ...
    async function search(): Promise<void> {
        ...
        searching = true;
        searchResults = await languageService.listSymbolsByWords(query); 
        searching = false; 
    }
...
<div class="w-full h-full">
    ...
    <div class="w-full p-6 bg-base-100 shadow-md rounded-xl">
        <h2 class="text-xl font-bold mb-2">Search symbols</h2>
        ...
        <a href="/lexora/symbols/new" class="btn btn-primary">
            Create new symbol
            <figure>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
